...
# Input audio path
input_audio_path = "D:\\Audio_Cloning_Project\\Input_audio\\1.wav"
...
def convert_to_colloquial_hinglish(text):
    # Simple Hinglish mix: Replace some technical/English keywords back into the Hindi text
    keywords = ["tuple", "list", "sample space", "code", "deck", "random", "card", "simulation", "select", "option", "capture"]
    for word in keywords:
        text = re.sub(fr"\b{word}\b", word, text, flags=re.IGNORECASE)
    return text
