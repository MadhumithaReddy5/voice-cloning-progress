...
dotenv_path = r"D:\Audio_Cloning_Project\.env"
...
input_audio_path = os.getenv('INPUT_AUDIO_PATH') or "D:\Audio_Cloning_Project\Results_audio_video\Vivek_sir_input.wav"
output_audio_path = os.getenv('OUTPUT_AUDIO_PATH') or "D:\Audio_Cloning_Project\Results_audio_video\cloned_audio_final.wav"
text_output_path = os.getenv('TEXT_OUTPUT_PATH') or "D:\Audio_Cloning_Project\Results_audio_video\translated_colloquial_hindi.txt"
